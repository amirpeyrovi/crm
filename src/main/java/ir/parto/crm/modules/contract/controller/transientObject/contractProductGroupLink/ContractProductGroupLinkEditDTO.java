...
public class ContractProductGroupLinkEditDTO {
    private Long contractTemplateId;
    private Long productGroupId;
    private Integer automatic;

    public ContractProductGroupLinkEditDTO() {
    }

    public ContractProductGroupLinkEditDTO(Long contractTemplateId, Long productGroupId, Integer automatic) {
