...
public class ContractServiceLinkEditDTO {
    private Long contractTemplateId;
    private Long serviceId;
    private Long serviceAddonId;

    public ContractServiceLinkEditDTO() {
    }

    public ContractServiceLinkEditDTO(Long contractTemplateId, Long serviceId, Long serviceAddonId) {
