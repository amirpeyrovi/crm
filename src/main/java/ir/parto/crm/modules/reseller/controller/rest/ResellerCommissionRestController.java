...
public class ResellerCommissionRestController implements RestControllerInterface {
    ...
    public Object findAll(@RequestParam(required = false, defaultValue = "0") String page,
        ...
        if (validateObject.getResult().equals("success")) {
            ...
            return new ApiResponse("Success", resellerCommissionPage)
                    .getSuccessResponse();
        } else {
    ...
    public Object findAllByResellerAndProductGroup(@PathVariable("id") Long id, @PathVariable("pgId") Long pgId,
                                                   @RequestParam(required = false, defaultValue = "0") String page,
                                                   @RequestParam(required = false, defaultValue = "default") String sortProperty,
                                                   @RequestParam(required = false, defaultValue = "asc") String sortOrder) {
        if (CheckPermission.getInstance().check("admin_show", "ResellerCommission")) {
    ...
    public Object addOne(@RequestBody ResellerCommission resellerCommission) {
        ...
        if (validateObject.getResult().equals("success")) {
            ...
            return new ApiResponse("Success", Arrays.asList(this.resellerCommissionService.addNewItem(resellerCommission)))
                    .getSuccessResponse();
        } else {
            return new ApiResponse("Error", 102, validateObject.getMessages())
                    .getFaultResponse();
    ...
    public Object updateOne(@PathVariable("id") Long id, @RequestBody ResellerCommission resellerCommission) {
        ...
        resellerCommission.setResellerCommissionId(id);
        ...
        if (validateObject.getResult().equals("success")) {
            try {
                resellerCommission.setReseller(this.resellerService.findOne(resellerCommission.getReseller()));
                resellerCommission.setProductGroup(this.productGroupService.findOne(resellerCommission.getProductGroup()));
                return new ApiResponse("Success", Arrays.asList(this.resellerCommissionService.updateItem(resellerCommission)))
                        .getSuccessResponse();
    ...
    public Object deleteOne(@PathVariable("id") Long id) {
        ...
        if (validateObject.getResult().equals("success")) {
            return new ApiResponse("Success", Arrays.asList(this.resellerCommissionService.deleteItem(resellerCommission)))
                    .getSuccessResponse();
        } else {
            return new ApiResponse("Error", 102, validateObject.getMessages())
                    .getFaultResponse();
    ...
    public Object findOne(@PathVariable("id") Long id) {
        ...
        if (validateObject.getResult().equals("success")) {
            return new ApiResponse("Success", Arrays.asList(this.resellerCommissionService.findOne(resellerCommission)))
                    .getSuccessResponse();
        } else {
            return new ApiResponse("Error", 102, validateObject.getMessages())
                    .getFaultResponse();
