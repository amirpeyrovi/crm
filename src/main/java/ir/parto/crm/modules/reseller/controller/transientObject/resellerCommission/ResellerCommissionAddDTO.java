...
public class ResellerCommissionAddDTO {
    private Long resellerId;
    private Long productGroupId;
    private Integer percentage;

    public ResellerCommissionAddDTO() {
    }

    public ResellerCommissionAddDTO(Long resellerId, Long productGroupId, Integer percentage) {
