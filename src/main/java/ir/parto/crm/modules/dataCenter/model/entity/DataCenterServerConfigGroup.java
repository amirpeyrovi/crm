...
@Entity
@Table(name = "crm_datacenter_server_config_group")
public class DataCenterServerConfigGroup implements Serializable {
    @Id
    ...
    public DataCenterServerConfigGroup() {
    }

    public DataCenterServerConfigGroup(String title, String description, String createdBy, String updatedBy, String deletedBy, LocalDateTime createdDate, LocalDateTime updatedDate, LocalDateTime deletedDate, Integer isDeleted) {
        this.title = title;
