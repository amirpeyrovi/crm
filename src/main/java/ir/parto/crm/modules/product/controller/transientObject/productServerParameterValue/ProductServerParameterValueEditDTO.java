...
public class ProductServerParameterValueEditDTO {
    private Long productId;
    private Long productAddonId;
    private Long serverParameterId;
    private String value;

    public ProductServerParameterValueEditDTO() {
    }

    public ProductServerParameterValueEditDTO(Long productId, Long productAddonId, Long serverParameterId, String value) {
