...
public class ProductParameterGroupLinkRelationalDTO {
    ...
    public ProductParameterGroupLinkRelationalDTO() {
    }


    public ProductParameterGroupLinkRelationalDTO(
            Long productParameterGroupLinkId, ProductParameterGroupRelationalDTO productParameterGroup,
            ProductRelationalDTO product, ProductAddonRelationalDTO productAddon) {
