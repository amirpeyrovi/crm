...
public class ProductAddonAddDTO {
    ...
    public ProductAddonAddDTO() {
    }

    public ProductAddonAddDTO(String title, String adminDescription, String clientDescription, String cover, Long productGroupId, Long serverGroupId, Integer haveWorkFlow, Long ticketStageId, Long ticketStateId, Integer haveTax, Integer adminHide, Integer clientHide, Integer retired) {
        this.title = title;
