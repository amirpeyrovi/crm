...
public class ProductCyclePriceAddDTO {
    ...
    public ProductCyclePriceAddDTO() {
    }

    public ProductCyclePriceAddDTO(Long productCycleId, Long productId, Long productAddonId, Long setupPrice, Long price) {
