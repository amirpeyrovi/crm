...
public class TicketStateActionDTO {
    private Long ticketStateActionId;
    private String title;
    private TicketStateActionTypeRelationalDTO ticketStateActionType;

    public TicketStateActionDTO() {
    }

    public TicketStateActionDTO(Long ticketStateActionId, String title, TicketStateActionTypeRelationalDTO ticketStateActionType) {
