...
public class TicketLogDTO {
    ...
    public TicketLogDTO(Long ticketLogId, TicketRelationalDTO ticket, TicketStageRelationalDTO ticketStage, TicketStateRelationalDTO ticketState, String createdBy, LocalDateTime createdDate) {
