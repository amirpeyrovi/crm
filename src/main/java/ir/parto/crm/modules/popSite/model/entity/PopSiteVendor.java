...
public class PopSiteVendor implements Serializable {
    ...
    public PopSiteVendor(String title, String model, String createdBy, String updatedBy, String deletedBy, LocalDateTime createdDate, LocalDateTime updatedDate, LocalDateTime deletedDate, Integer isDeleted) {
        this.title = title;
        this.model = model;
